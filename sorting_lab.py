...
for pos in range(len(nba_leader_list)):
    min_pos = pos
    for sort_pos in range(min_pos, len(nba_leader_list)):
        if nba_leader_list[sort_pos][1] < nba_leader_list[min_pos][1]:
            min_pos = sort_pos
    temp = nba_leader_list[pos]
    nba_leader_list[pos] = nba_leader_list[min_pos]
    nba_leader_list[min_pos] = temp
